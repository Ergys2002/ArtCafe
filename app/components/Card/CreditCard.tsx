    ...
    return (
        ...
        >
            {debitcard ? (
                <Image
                    style={{
                        height: creditCard ? 180 : 150,
                        width: creditCard ? "100%" : 277,
                        borderRadius: 18,
                    }}
            ...
            >
                ...
                <View style={[GlobalStyleSheet.flex]}>
                    <View>
                        <Text style={styles.CardTitle}>REDJON BELISHTA</Text>
                        <Text
                            style={{
                                ...FONTS.fontMedium,
                                fontSize: creditCard ? 20 : 14,
                                color: COLORS.white,
                            }}
                        >
                            **** **** **** 4532
