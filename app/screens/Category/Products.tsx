...
const CardStyleData = [
    ...
    // Removed Tea product to maintain coffee-only focus
    {
        id: "8",
        image: IMAGES.item13,
        title: "Arabica Latte Art Coffee",
        price: "$51.6",
        brand: "Coffee",
    },
    {
...
const Products = ({ navigation }: ProductsScreenProps) => {
    ...
    const [routes] = React.useState([
        { key: "first", title: "Espresso" },
        { key: "second", title: "Cappuccino" },
        { key: "Three", title: "Latte" },
    ]);
    ...
    return (
        ...
        >
            <Header title="Products" leftIcon="back" rightIcon3={"cart"} />
            <View
                style={[
